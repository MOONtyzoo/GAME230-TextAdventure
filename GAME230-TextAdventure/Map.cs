...
public static class Map
{
    ...
    public static void Initialize()
    {
        ...
        Item key = new Item("Key", "Maybe I can unlock something with this...", "There is a key here.", true, true);
        entranceHall.AddItem(key);
        Vocabulary.AddNoun(key.name);
        
        Item beer = new Item("Beer", "Alcoholism.", "There is a beer here.", true, true);
        entranceHall.AddItem(beer);
        Vocabulary.AddNoun(beer.name);
        
        Item chair = new Item("Chair", "You shouldn't be able to read this", "There is a chair here.", false, true);
        entranceHall.AddItem(chair);
        Vocabulary.AddNoun(chair.name);
    }
}